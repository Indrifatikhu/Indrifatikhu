"""
Django settings for django_baru project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-9=r+d!eg=r@fnm3o(2l)!wd3s5@%vpcq^5xd3ez0#o=$tfdts)')
...
WSGI_APPLICATION = 'django_baru.wsgi.application'
